...
###########################
# conclusion: 
# we used principal component analysis on unscaled data
# 2 PCs explain almost 36% of the variance in the type of leukemia
# point 22 appears to be mislabeled
###########################
...
#look at coordinates of point 22
new[19,]

#calculate distance to each
dtoB <- sqrt((new[19,1]-meanB[1])**2 + (new[19,2]-meanB[2])**2)
dtoG <- sqrt((new[19,1]-meanG[1])**2 + (new[19,2]-meanG[2])**2)

###########################
# conclusion:
# point 22 is much closer to the center of the blue cluster than 
# to the center of the green cluster
